...
​      \* [1、Linux进程空间划分](#1linux进程空间划分)

​         \* [1.1 代码段（code segment/text segment）](#11-代码段code-segmenttext-segment)

​         \* [1.2 数据段(data segment)](#12-数据段data-segment)

​         \* [1.3 bss段(bss segment)](#13-bss段bss-segment)

​         \* [1.4 堆](#14-堆)

​         \* [1.5 文件内存映射与匿名映射区](#15-文件内存映射与匿名映射区)

​            \* [1.5.1 文件内存映射](#151-文件内存映射)

​            \* [1.5.2 匿名映射区](#152-匿名映射区)

​         \* [1.6 用户栈](#16-用户栈)

​         \* [1.7 内核虚拟内存](#17-内核虚拟内存)

​      \* [2、linux 进程、轻量级进程的地址空间](#2linux-进程轻量级进程的地址空间)

​         \* [2.1 轻量级进程(LWP)的地址空间](#21-轻量级进程lwp的地址空间)

​         \* [2.2 进程的地址空间](#22-进程的地址空间)

​      \* [3、Linux进程分配空间的方式](#3linux进程分配空间的方式)
...
​            \* [3.2.1 malloc()函数](#321-malloc函数)

​            \* [3.2.2 mmap()函数(与系统调用同名)](#322-mmap函数与系统调用同名)
