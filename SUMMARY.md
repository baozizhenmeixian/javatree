...
* [执行准备](language-symbol-organization/execute-preperation/README.md)
  ...
  * [链接](language-symbol-organization/execute-preperation/linking/README.md)
    * [准备](language-symbol-organization/execute-preperation/linking/preperation.md)
    * [验证](language-symbol-organization/execute-preperation/linking/verification.md)
    * [解析](language-symbol-organization/execute-preperation/linking/resolution/README.md)
      * [覆盖\(overriding\)](language-symbol-organization/execute-preperation/linking/resolution/overriding.md)
...
* [JVM运行时数据区](space-memory-management/jvm-yun-hang-shi-shu-ju-qu/README.md)
  ...
  * [方法区](space-memory-management/jvm-yun-hang-shi-shu-ju-qu/fang-fa-qu/README.md)
    * [运行时常量池](space-memory-management/jvm-yun-hang-shi-shu-ju-qu/fang-fa-qu/yun-hang-shi-chang-liang-chi.md)
  * [java堆](space-memory-management/jvm-yun-hang-shi-shu-ju-qu/java-dui.md)
